        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-clean-white/70 text-sm leading-relaxed mb-6 max-w-sm">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 flex items-center justify-center border border-clean-white/20 text-clean-white/60 hover:text-clean-white hover:border-clean-white/40 transition-colors"
                  aria-label="Facebook"
                >
              ...
              <ul className="space-y-2">
                {footerLinks.services.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-clean-white/70 hover:text-clean-white transition-colors"
                    >
                      {link.name}
                    </Link>
                  </li>
            ...
            {/* Neighborhoods */}
            <div>
              <h3 className="font-display font-semibold text-lg mb-4">We Serve</h3>
              <ul className="space-y-2">
